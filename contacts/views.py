...
def inquiry(request):
	if request.method == 'POST':
		...
		contact = Contact(car_id=car_id, car_title=car_title, first_name=first_name,
		...
		send_mail(
				'New Car Inquiry',
				'You have new inquiry for car ' + car_title + '. Please login to your admin panel for more info.',
				'dream.car.alain@gmail.com',
				[admin_email],
				fail_silently=False,
			)
